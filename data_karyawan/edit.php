...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE tb_karyawan SET nik='$nik', nama='$nama', no_telp='$no_telp', tmt='$tmt',  jabatan='$jabatan', foto='$target_file' WHERE id=" . $_GET['id'];
    if ($conn->query($query)) {
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" placeholder="Masukkan Jabatan" name="jabatan" value="<?= $row['jabatan'] ?>">
                                </div>
                                <div class="form-group">
