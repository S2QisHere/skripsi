...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tb_karyawan (nik, nama, no_telp, tmt,  jabatan, foto) VALUES ('$nik', '$nama', '$no_telp', '$tmt', '$jabatan', '$target_file')";
    if ($conn->query($query)) {
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" placeholder="Masukkan Jabatan" name="jabatan">
                                </div>
                                <div class="form-group">
