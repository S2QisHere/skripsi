                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nik" id="nik" required autocomplete="off" autofocus value="<?= isset($_POST['submit']) ? $_POST['nik'] : ''; ?>" placeholder="Masukkan NIK">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nomor_telepon" id="nomor_telepon" required autocomplete="off" value="<?= isset($_POST['submit']) ? $_POST['nomor_telepon'] : ''; ?>" placeholder="Masukkan nomor telepon">
                                </div>
                                <div class="form-group">
                            ...
                            <form>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="konfirmasi_password" placeholder="Masukkan Konfirmais Password" required name="konfirmasi_password">
                                    </div>
                                </div>
                                <!-- /.card-body -->
