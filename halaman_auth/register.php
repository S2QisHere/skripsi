  ...
  if ($result->num_rows == 0) {
    if ($password === $konfirmasi_password) {
      ...
      if ($conn->query($query)) {
        ...
        if ($conn->query($query)) {
          echo "<script>alert('Pendaftaran Akun Berhasil! Silakan Login!');</script>";
    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            <input type="text" class="form-control" autocomplete="off" required name="nomor_telepon" placeholder="Nomor Telepon" value="<?= isset($_POST['submit']) ? $_POST['nomor_telepon'] : ''; ?>">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-user"></span>
              </div>
          ...
          <div class="input-group mb-3">
            <input type="email" class="form-control" autocomplete="off" required name="email" placeholder="Email" value="<?= isset($_POST['submit']) ? $_POST['email'] : ''; ?>">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3">
            <input type="password" class="form-control" autocomplete="off" required name="password" placeholder="Password">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3">
            <input type="password" class="form-control" autocomplete="off" required name="konfirmasi_password" placeholder="Retype password">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-lock"></span>
              </div>
